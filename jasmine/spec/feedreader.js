...
describe("Initial Entries",function(){
   ...
   describe("New Feed Selection",function(){
     ...
     const check = document.getElementsByClassName("entry");
     it("load feed", function(){
       expect(check[2].textContent).not.toBe(check[3].textContent);
     });
